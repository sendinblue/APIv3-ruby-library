...
module SibApiV3Sdk
  class TransactionalEmailsApi
    ...
    def get_email_event_report_with_http_info(opts = {})
      ...
      allowable_values = ["bounces", "hardBounces", "softBounces", "delivered", "spam", "requests", "opened", "clicks", "invalid", "deferred", "blocked", "unsubscribed", "error"]
    ...
    def send_template_with_http_info(template_id, send_email, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.send_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def smtp_log_message_id_delete_with_http_info(message_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TransactionalEmailsApi.smtp_log_message_id_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
