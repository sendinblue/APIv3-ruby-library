...
module SibApiV3Sdk
  class ContactsApi
    ...
    # @param contact_emails [AddContactToList] Emails addresses OR IDs of the contacts
    ...
    # Delete a contact
    # @param identifier [String] Email (urlencoded) OR ID of the contact
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    # @param identifier [String] Email (urlencoded) OR ID of the contact OR its SMS attribute value
    # @param [Hash] opts the optional parameters
    ...
    # @param list_id [Integer] Id of the list
    # @param contact_emails [RemoveContactFromList] Emails addresses OR IDs of the contacts
    # @param [Hash] opts the optional parameters
    # @return [PostContactInfo]
