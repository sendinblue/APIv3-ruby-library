...
module SendinblueApiv3
  ...
  class GetEmailCampaign
    ...
    def list_invalid_properties
      ...
      if @scheduled_at !~ Regexp.new(/YYYY-MM-DD HH:mm:ss/)
      ...
      if @created_at !~ Regexp.new(/YYYY-MM-DD HH:mm:ss/)
        invalid_properties.push("invalid value for 'created_at', must conform to the pattern /YYYY-MM-DD HH:mm:ss/.")
      end
      ...
      if @modified_at !~ Regexp.new(/YYYY-MM-DD HH:mm:ss/)
        invalid_properties.push("invalid value for 'modified_at', must conform to the pattern /YYYY-MM-DD HH:mm:ss/.")
      end
    ...
    def valid?
      ...
      return false if @scheduled_at !~ Regexp.new(/YYYY-MM-DD HH:mm:ss/)
      ...
      return false if @created_at !~ Regexp.new(/YYYY-MM-DD HH:mm:ss/)
      return false if @modified_at.nil?
      return false if @modified_at !~ Regexp.new(/YYYY-MM-DD HH:mm:ss/)
      return true
    end
    ...
    def created_at=(created_at)
      ...
      if created_at !~ Regexp.new(/YYYY-MM-DD HH:mm:ss/)
        fail ArgumentError, "invalid value for 'created_at', must conform to the pattern /YYYY-MM-DD HH:mm:ss/."
      end
    ...
    def modified_at=(modified_at)
      ...
      if modified_at !~ Regexp.new(/YYYY-MM-DD HH:mm:ss/)
        fail ArgumentError, "invalid value for 'modified_at', must conform to the pattern /YYYY-MM-DD HH:mm:ss/."
      end
