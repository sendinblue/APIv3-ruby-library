...
# Unit tests for SendinblueApiv3::SMSCampaignsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SMSCampaignsApi' do
  before do
    # run before each test
    @instance = SendinblueApiv3::SMSCampaignsApi.new
  end
  ...
  describe 'test an instance of SMSCampaignsApi' do
    it 'should create an instance of SMSCampaignsApi' do
      expect(@instance).to be_instance_of(SendinblueApiv3::SMSCampaignsApi)
    end
  end
