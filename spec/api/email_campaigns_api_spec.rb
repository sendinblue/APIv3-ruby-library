...
# Unit tests for SendinblueApiv3::EmailCampaignsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailCampaignsApi' do
  before do
    # run before each test
    @instance = SendinblueApiv3::EmailCampaignsApi.new
  end
  ...
  describe 'test an instance of EmailCampaignsApi' do
    it 'should create an instance of EmailCampaignsApi' do
      expect(@instance).to be_instance_of(SendinblueApiv3::EmailCampaignsApi)
    end
  end
  ...
  # unit tests for delete_email_campaigns
  # Delete an email campaign
  # 
  # @param campaign_id id of the campaign
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_email_campaigns test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for update_email_campaigns
  # Update a campaign
  # 
  # @param campaign_id Id of the campaign
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'update_email_campaigns test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
