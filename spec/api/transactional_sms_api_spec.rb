...
# Unit tests for SendinblueApiv3::TransactionalSMSApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionalSMSApi' do
  before do
    # run before each test
    @instance = SendinblueApiv3::TransactionalSMSApi.new
  end
  ...
  describe 'test an instance of TransactionalSMSApi' do
    it 'should create an instance of TransactionalSMSApi' do
      expect(@instance).to be_instance_of(SendinblueApiv3::TransactionalSMSApi)
    end
  end
