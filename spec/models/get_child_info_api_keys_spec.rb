...
# Unit tests for SendinblueApiv3::GetChildInfoApiKeys
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetChildInfoApiKeys' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetChildInfoApiKeys.new
  end
  ...
  describe 'test an instance of GetChildInfoApiKeys' do
    it 'should create an instance of GetChildInfoApiKeys' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetChildInfoApiKeys)
    end
  end
