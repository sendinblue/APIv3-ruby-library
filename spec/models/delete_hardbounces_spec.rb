...
# Unit tests for SendinblueApiv3::DeleteHardbounces
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeleteHardbounces' do
  before do
    # run before each test
    @instance = SendinblueApiv3::DeleteHardbounces.new
  end
  ...
  describe 'test an instance of DeleteHardbounces' do
    it 'should create an instance of DeleteHardbounces' do
      expect(@instance).to be_instance_of(SendinblueApiv3::DeleteHardbounces)
    end
  end
