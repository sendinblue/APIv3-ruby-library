...
# Unit tests for SendinblueApiv3::GetChildInfoStatistics
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetChildInfoStatistics' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetChildInfoStatistics.new
  end
  ...
  describe 'test an instance of GetChildInfoStatistics' do
    it 'should create an instance of GetChildInfoStatistics' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetChildInfoStatistics)
    end
  end
