...
# Unit tests for SendinblueApiv3::GetContactCampaignStatsTransacAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStatsTransacAttributes' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetContactCampaignStatsTransacAttributes.new
  end
  ...
  describe 'test an instance of GetContactCampaignStatsTransacAttributes' do
    it 'should create an instance of GetContactCampaignStatsTransacAttributes' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetContactCampaignStatsTransacAttributes)
    end
  end
