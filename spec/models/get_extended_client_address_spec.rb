...
# Unit tests for SendinblueApiv3::GetExtendedClientAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedClientAddress' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetExtendedClientAddress.new
  end
  ...
  describe 'test an instance of GetExtendedClientAddress' do
    it 'should create an instance of GetExtendedClientAddress' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetExtendedClientAddress)
    end
  end
