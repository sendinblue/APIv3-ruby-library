...
# Unit tests for SendinblueApiv3::GetContactCampaignStatsMessagesSent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStatsMessagesSent' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetContactCampaignStatsMessagesSent.new
  end
  ...
  describe 'test an instance of GetContactCampaignStatsMessagesSent' do
    it 'should create an instance of GetContactCampaignStatsMessagesSent' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetContactCampaignStatsMessagesSent)
    end
  end
