...
# Unit tests for SendinblueApiv3::GetChildrenList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetChildrenList' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetChildrenList.new
  end
  ...
  describe 'test an instance of GetChildrenList' do
    it 'should create an instance of GetChildrenList' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetChildrenList)
    end
  end
