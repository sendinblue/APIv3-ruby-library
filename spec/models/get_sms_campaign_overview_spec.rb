...
# Unit tests for SendinblueApiv3::GetSmsCampaignOverview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSmsCampaignOverview' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetSmsCampaignOverview.new
  end
  ...
  describe 'test an instance of GetSmsCampaignOverview' do
    it 'should create an instance of GetSmsCampaignOverview' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetSmsCampaignOverview)
    end
  end
