...
# Unit tests for SendinblueApiv3::GetCampaignStats
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCampaignStats' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetCampaignStats.new
  end
  ...
  describe 'test an instance of GetCampaignStats' do
    it 'should create an instance of GetCampaignStats' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetCampaignStats)
    end
  end
