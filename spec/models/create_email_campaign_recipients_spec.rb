...
# Unit tests for SendinblueApiv3::CreateEmailCampaignRecipients
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateEmailCampaignRecipients' do
  before do
    # run before each test
    @instance = SendinblueApiv3::CreateEmailCampaignRecipients.new
  end
  ...
  describe 'test an instance of CreateEmailCampaignRecipients' do
    it 'should create an instance of CreateEmailCampaignRecipients' do
      expect(@instance).to be_instance_of(SendinblueApiv3::CreateEmailCampaignRecipients)
    end
  end
