...
# Unit tests for SendinblueApiv3::CreateAttribute
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateAttribute' do
  before do
    # run before each test
    @instance = SendinblueApiv3::CreateAttribute.new
  end
  ...
  describe 'test an instance of CreateAttribute' do
    it 'should create an instance of CreateAttribute' do
      expect(@instance).to be_instance_of(SendinblueApiv3::CreateAttribute)
    end
  end
