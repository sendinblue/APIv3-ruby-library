...
# Unit tests for SendinblueApiv3::GetSendersListSenders
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSendersListSenders' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetSendersListSenders.new
  end
  ...
  describe 'test an instance of GetSendersListSenders' do
    it 'should create an instance of GetSendersListSenders' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetSendersListSenders)
    end
  end
