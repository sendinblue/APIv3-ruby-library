...
# Unit tests for SendinblueApiv3::GetReportsReports
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetReportsReports' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetReportsReports.new
  end
  ...
  describe 'test an instance of GetReportsReports' do
    it 'should create an instance of GetReportsReports' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetReportsReports)
    end
  end
