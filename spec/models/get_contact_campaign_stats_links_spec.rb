...
# Unit tests for SendinblueApiv3::GetContactCampaignStatsLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStatsLinks' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetContactCampaignStatsLinks.new
  end
  ...
  describe 'test an instance of GetContactCampaignStatsLinks' do
    it 'should create an instance of GetContactCampaignStatsLinks' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetContactCampaignStatsLinks)
    end
  end
