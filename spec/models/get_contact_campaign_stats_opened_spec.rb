...
# Unit tests for SendinblueApiv3::GetContactCampaignStatsOpened
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStatsOpened' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetContactCampaignStatsOpened.new
  end
  ...
  describe 'test an instance of GetContactCampaignStatsOpened' do
    it 'should create an instance of GetContactCampaignStatsOpened' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetContactCampaignStatsOpened)
    end
  end
