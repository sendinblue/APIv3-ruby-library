...
# Unit tests for SendinblueApiv3::GetTransacAggregatedSmsReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTransacAggregatedSmsReport' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetTransacAggregatedSmsReport.new
  end
  ...
  describe 'test an instance of GetTransacAggregatedSmsReport' do
    it 'should create an instance of GetTransacAggregatedSmsReport' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetTransacAggregatedSmsReport)
    end
  end
