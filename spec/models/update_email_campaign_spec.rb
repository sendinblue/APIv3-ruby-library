...
# Unit tests for SendinblueApiv3::UpdateEmailCampaign
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateEmailCampaign' do
  before do
    # run before each test
    @instance = SendinblueApiv3::UpdateEmailCampaign.new
  end
  ...
  describe 'test an instance of UpdateEmailCampaign' do
    it 'should create an instance of UpdateEmailCampaign' do
      expect(@instance).to be_instance_of(SendinblueApiv3::UpdateEmailCampaign)
    end
  end
