...
# Unit tests for SendinblueApiv3::CreateSmtpTemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSmtpTemplate' do
  before do
    # run before each test
    @instance = SendinblueApiv3::CreateSmtpTemplate.new
  end
  ...
  describe 'test an instance of CreateSmtpTemplate' do
    it 'should create an instance of CreateSmtpTemplate' do
      expect(@instance).to be_instance_of(SendinblueApiv3::CreateSmtpTemplate)
    end
  end
