...
# Unit tests for SendinblueApiv3::UpdateEmailCampaignRecipients
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateEmailCampaignRecipients' do
  before do
    # run before each test
    @instance = SendinblueApiv3::UpdateEmailCampaignRecipients.new
  end
  ...
  describe 'test an instance of UpdateEmailCampaignRecipients' do
    it 'should create an instance of UpdateEmailCampaignRecipients' do
      expect(@instance).to be_instance_of(SendinblueApiv3::UpdateEmailCampaignRecipients)
    end
  end
