...
# Unit tests for SendinblueApiv3::CreateSmsCampaign
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSmsCampaign' do
  before do
    # run before each test
    @instance = SendinblueApiv3::CreateSmsCampaign.new
  end
  ...
  describe 'test an instance of CreateSmsCampaign' do
    it 'should create an instance of CreateSmsCampaign' do
      expect(@instance).to be_instance_of(SendinblueApiv3::CreateSmsCampaign)
    end
  end
