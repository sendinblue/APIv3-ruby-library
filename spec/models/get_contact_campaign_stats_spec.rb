...
# Unit tests for SendinblueApiv3::GetContactCampaignStats
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStats' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetContactCampaignStats.new
  end
  ...
  describe 'test an instance of GetContactCampaignStats' do
    it 'should create an instance of GetContactCampaignStats' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetContactCampaignStats)
    end
  end
