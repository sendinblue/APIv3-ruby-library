...
# Unit tests for SendinblueApiv3::GetExtendedContactDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedContactDetails' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetExtendedContactDetails.new
  end
  ...
  describe 'test an instance of GetExtendedContactDetails' do
    it 'should create an instance of GetExtendedContactDetails' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetExtendedContactDetails)
    end
  end
