...
# Unit tests for SendinblueApiv3::GetAggregatedReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAggregatedReport' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetAggregatedReport.new
  end
  ...
  describe 'test an instance of GetAggregatedReport' do
    it 'should create an instance of GetAggregatedReport' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetAggregatedReport)
    end
  end
