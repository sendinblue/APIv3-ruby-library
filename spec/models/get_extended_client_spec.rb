...
# Unit tests for SendinblueApiv3::GetExtendedClient
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedClient' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetExtendedClient.new
  end
  ...
  describe 'test an instance of GetExtendedClient' do
    it 'should create an instance of GetExtendedClient' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetExtendedClient)
    end
  end
