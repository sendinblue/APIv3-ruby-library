...
# Unit tests for SendinblueApiv3::GetAccountPlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAccountPlan' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetAccountPlan.new
  end
  ...
  describe 'test an instance of GetAccountPlan' do
    it 'should create an instance of GetAccountPlan' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetAccountPlan)
    end
  end
