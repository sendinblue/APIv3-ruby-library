...
# Unit tests for SendinblueApiv3::GetContactCampaignStatsUnsubscriptionsUserUnsubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStatsUnsubscriptionsUserUnsubscription' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetContactCampaignStatsUnsubscriptionsUserUnsubscription.new
  end
  ...
  describe 'test an instance of GetContactCampaignStatsUnsubscriptionsUserUnsubscription' do
    it 'should create an instance of GetContactCampaignStatsUnsubscriptionsUserUnsubscription' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetContactCampaignStatsUnsubscriptionsUserUnsubscription)
    end
  end
