...
# Unit tests for SendinblueApiv3::SendReportEmail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendReportEmail' do
  before do
    # run before each test
    @instance = SendinblueApiv3::SendReportEmail.new
  end
  ...
  describe 'test an instance of SendReportEmail' do
    it 'should create an instance of SendReportEmail' do
      expect(@instance).to be_instance_of(SendinblueApiv3::SendReportEmail)
    end
  end
