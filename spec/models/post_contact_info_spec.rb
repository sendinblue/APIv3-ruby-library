...
# Unit tests for SendinblueApiv3::PostContactInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostContactInfo' do
  before do
    # run before each test
    @instance = SendinblueApiv3::PostContactInfo.new
  end
  ...
  describe 'test an instance of PostContactInfo' do
    it 'should create an instance of PostContactInfo' do
      expect(@instance).to be_instance_of(SendinblueApiv3::PostContactInfo)
    end
  end
