...
# Unit tests for SendinblueApiv3::RequestContactImport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestContactImport' do
  before do
    # run before each test
    @instance = SendinblueApiv3::RequestContactImport.new
  end
  ...
  describe 'test an instance of RequestContactImport' do
    it 'should create an instance of RequestContactImport' do
      expect(@instance).to be_instance_of(SendinblueApiv3::RequestContactImport)
    end
  end
