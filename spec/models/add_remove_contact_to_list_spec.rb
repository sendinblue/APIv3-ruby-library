...
# Unit tests for SendinblueApiv3::AddRemoveContactToList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddRemoveContactToList' do
  before do
    # run before each test
    @instance = SendinblueApiv3::AddRemoveContactToList.new
  end
  ...
  describe 'test an instance of AddRemoveContactToList' do
    it 'should create an instance of AddRemoveContactToList' do
      expect(@instance).to be_instance_of(SendinblueApiv3::AddRemoveContactToList)
    end
  end
