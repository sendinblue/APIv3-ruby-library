...
# Unit tests for SendinblueApiv3::GetSendersList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSendersList' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetSendersList.new
  end
  ...
  describe 'test an instance of GetSendersList' do
    it 'should create an instance of GetSendersList' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetSendersList)
    end
  end
