...
# Unit tests for SendinblueApiv3::GetContactDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactDetails' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetContactDetails.new
  end
  ...
  describe 'test an instance of GetContactDetails' do
    it 'should create an instance of GetContactDetails' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetContactDetails)
    end
  end
