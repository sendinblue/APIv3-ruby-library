...
# Unit tests for SendinblueApiv3::GetExtendedCampaignOverview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedCampaignOverview' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetExtendedCampaignOverview.new
  end
  ...
  describe 'test an instance of GetExtendedCampaignOverview' do
    it 'should create an instance of GetExtendedCampaignOverview' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetExtendedCampaignOverview)
    end
  end
