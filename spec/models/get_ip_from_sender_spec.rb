...
# Unit tests for SendinblueApiv3::GetIpFromSender
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetIpFromSender' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetIpFromSender.new
  end
  ...
  describe 'test an instance of GetIpFromSender' do
    it 'should create an instance of GetIpFromSender' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetIpFromSender)
    end
  end
