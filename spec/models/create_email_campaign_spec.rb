...
# Unit tests for SendinblueApiv3::CreateEmailCampaign
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateEmailCampaign' do
  before do
    # run before each test
    @instance = SendinblueApiv3::CreateEmailCampaign.new
  end
  ...
  describe 'test an instance of CreateEmailCampaign' do
    it 'should create an instance of CreateEmailCampaign' do
      expect(@instance).to be_instance_of(SendinblueApiv3::CreateEmailCampaign)
    end
  end
