...
# Unit tests for SendinblueApiv3::GetFolderLists
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFolderLists' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetFolderLists.new
  end
  ...
  describe 'test an instance of GetFolderLists' do
    it 'should create an instance of GetFolderLists' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetFolderLists)
    end
  end
