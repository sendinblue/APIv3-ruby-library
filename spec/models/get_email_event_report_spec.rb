...
# Unit tests for SendinblueApiv3::GetEmailEventReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEmailEventReport' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetEmailEventReport.new
  end
  ...
  describe 'test an instance of GetEmailEventReport' do
    it 'should create an instance of GetEmailEventReport' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetEmailEventReport)
    end
  end
