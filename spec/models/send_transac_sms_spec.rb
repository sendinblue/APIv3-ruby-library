...
# Unit tests for SendinblueApiv3::SendTransacSms
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendTransacSms' do
  before do
    # run before each test
    @instance = SendinblueApiv3::SendTransacSms.new
  end
  ...
  describe 'test an instance of SendTransacSms' do
    it 'should create an instance of SendTransacSms' do
      expect(@instance).to be_instance_of(SendinblueApiv3::SendTransacSms)
    end
  end
