...
# Unit tests for SendinblueApiv3::CreateSmtpEmail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSmtpEmail' do
  before do
    # run before each test
    @instance = SendinblueApiv3::CreateSmtpEmail.new
  end
  ...
  describe 'test an instance of CreateSmtpEmail' do
    it 'should create an instance of CreateSmtpEmail' do
      expect(@instance).to be_instance_of(SendinblueApiv3::CreateSmtpEmail)
    end
  end
