...
# Unit tests for SendinblueApiv3::GetSmsCampaigns
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSmsCampaigns' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetSmsCampaigns.new
  end
  ...
  describe 'test an instance of GetSmsCampaigns' do
    it 'should create an instance of GetSmsCampaigns' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetSmsCampaigns)
    end
  end
