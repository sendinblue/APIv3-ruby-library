...
# Unit tests for SendinblueApiv3::GetAttributesAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAttributesAttributes' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetAttributesAttributes.new
  end
  ...
  describe 'test an instance of GetAttributesAttributes' do
    it 'should create an instance of GetAttributesAttributes' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetAttributesAttributes)
    end
  end
