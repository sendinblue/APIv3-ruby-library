...
# Unit tests for SendinblueApiv3::GetEmailCampaigns
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEmailCampaigns' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetEmailCampaigns.new
  end
  ...
  describe 'test an instance of GetEmailCampaigns' do
    it 'should create an instance of GetEmailCampaigns' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetEmailCampaigns)
    end
  end
