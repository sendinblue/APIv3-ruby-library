...
# Unit tests for SendinblueApiv3::CreatedProcessId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreatedProcessId' do
  before do
    # run before each test
    @instance = SendinblueApiv3::CreatedProcessId.new
  end
  ...
  describe 'test an instance of CreatedProcessId' do
    it 'should create an instance of CreatedProcessId' do
      expect(@instance).to be_instance_of(SendinblueApiv3::CreatedProcessId)
    end
  end
