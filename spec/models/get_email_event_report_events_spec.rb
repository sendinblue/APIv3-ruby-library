...
# Unit tests for SendinblueApiv3::GetEmailEventReportEvents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEmailEventReportEvents' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetEmailEventReportEvents.new
  end
  ...
  describe 'test an instance of GetEmailEventReportEvents' do
    it 'should create an instance of GetEmailEventReportEvents' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetEmailEventReportEvents)
    end
  end
