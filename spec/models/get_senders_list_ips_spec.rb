...
# Unit tests for SendinblueApiv3::GetSendersListIps
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSendersListIps' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetSendersListIps.new
  end
  ...
  describe 'test an instance of GetSendersListIps' do
    it 'should create an instance of GetSendersListIps' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetSendersListIps)
    end
  end
