...
# Unit tests for SendinblueApiv3::GetSmsCampaignStats
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSmsCampaignStats' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetSmsCampaignStats.new
  end
  ...
  describe 'test an instance of GetSmsCampaignStats' do
    it 'should create an instance of GetSmsCampaignStats' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetSmsCampaignStats)
    end
  end
