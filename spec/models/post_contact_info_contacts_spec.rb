...
# Unit tests for SendinblueApiv3::PostContactInfoContacts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostContactInfoContacts' do
  before do
    # run before each test
    @instance = SendinblueApiv3::PostContactInfoContacts.new
  end
  ...
  describe 'test an instance of PostContactInfoContacts' do
    it 'should create an instance of PostContactInfoContacts' do
      expect(@instance).to be_instance_of(SendinblueApiv3::PostContactInfoContacts)
    end
  end
