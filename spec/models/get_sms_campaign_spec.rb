...
# Unit tests for SendinblueApiv3::GetSmsCampaign
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSmsCampaign' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetSmsCampaign.new
  end
  ...
  describe 'test an instance of GetSmsCampaign' do
    it 'should create an instance of GetSmsCampaign' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetSmsCampaign)
    end
  end
