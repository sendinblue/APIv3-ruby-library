...
# Unit tests for SendinblueApiv3::CreateSenderIps
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSenderIps' do
  before do
    # run before each test
    @instance = SendinblueApiv3::CreateSenderIps.new
  end
  ...
  describe 'test an instance of CreateSenderIps' do
    it 'should create an instance of CreateSenderIps' do
      expect(@instance).to be_instance_of(SendinblueApiv3::CreateSenderIps)
    end
  end
