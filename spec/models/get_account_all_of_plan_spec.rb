...
# Unit tests for SibApiV3Sdk::GetAccountAllOfPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SibApiV3Sdk::GetAccountAllOfPlan do
  let(:instance) { SibApiV3Sdk::GetAccountAllOfPlan.new }

  describe 'test an instance of GetAccountAllOfPlan' do
    it 'should create an instance of GetAccountAllOfPlan' do
      expect(instance).to be_instance_of(SibApiV3Sdk::GetAccountAllOfPlan)
    end
  end
