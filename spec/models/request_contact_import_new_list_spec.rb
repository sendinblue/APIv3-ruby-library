...
# Unit tests for SendinblueApiv3::RequestContactImportNewList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestContactImportNewList' do
  before do
    # run before each test
    @instance = SendinblueApiv3::RequestContactImportNewList.new
  end
  ...
  describe 'test an instance of RequestContactImportNewList' do
    it 'should create an instance of RequestContactImportNewList' do
      expect(@instance).to be_instance_of(SendinblueApiv3::RequestContactImportNewList)
    end
  end
