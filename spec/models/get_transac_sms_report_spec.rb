...
# Unit tests for SendinblueApiv3::GetTransacSmsReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTransacSmsReport' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetTransacSmsReport.new
  end
  ...
  describe 'test an instance of GetTransacSmsReport' do
    it 'should create an instance of GetTransacSmsReport' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetTransacSmsReport)
    end
  end
