...
# Unit tests for SendinblueApiv3::GetTransacSmsReportReports
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTransacSmsReportReports' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetTransacSmsReportReports.new
  end
  ...
  describe 'test an instance of GetTransacSmsReportReports' do
    it 'should create an instance of GetTransacSmsReportReports' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetTransacSmsReportReports)
    end
  end
