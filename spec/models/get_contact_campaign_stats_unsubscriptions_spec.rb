...
# Unit tests for SendinblueApiv3::GetContactCampaignStatsUnsubscriptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStatsUnsubscriptions' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetContactCampaignStatsUnsubscriptions.new
  end
  ...
  describe 'test an instance of GetContactCampaignStatsUnsubscriptions' do
    it 'should create an instance of GetContactCampaignStatsUnsubscriptions' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetContactCampaignStatsUnsubscriptions)
    end
  end
