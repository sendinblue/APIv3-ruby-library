...
# Unit tests for SendinblueApiv3::UpdateSmtpTemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateSmtpTemplate' do
  before do
    # run before each test
    @instance = SendinblueApiv3::UpdateSmtpTemplate.new
  end
  ...
  describe 'test an instance of UpdateSmtpTemplate' do
    it 'should create an instance of UpdateSmtpTemplate' do
      expect(@instance).to be_instance_of(SendinblueApiv3::UpdateSmtpTemplate)
    end
  end
