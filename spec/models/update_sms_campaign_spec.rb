...
# Unit tests for SendinblueApiv3::UpdateSmsCampaign
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateSmsCampaign' do
  before do
    # run before each test
    @instance = SendinblueApiv3::UpdateSmsCampaign.new
  end
  ...
  describe 'test an instance of UpdateSmsCampaign' do
    it 'should create an instance of UpdateSmsCampaign' do
      expect(@instance).to be_instance_of(SendinblueApiv3::UpdateSmsCampaign)
    end
  end
