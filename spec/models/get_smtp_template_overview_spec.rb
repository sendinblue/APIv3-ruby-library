...
# Unit tests for SendinblueApiv3::GetSmtpTemplateOverview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSmtpTemplateOverview' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetSmtpTemplateOverview.new
  end
  ...
  describe 'test an instance of GetSmtpTemplateOverview' do
    it 'should create an instance of GetSmtpTemplateOverview' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetSmtpTemplateOverview)
    end
  end
