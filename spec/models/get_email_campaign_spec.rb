...
# Unit tests for SendinblueApiv3::GetEmailCampaign
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEmailCampaign' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetEmailCampaign.new
  end
  ...
  describe 'test an instance of GetEmailCampaign' do
    it 'should create an instance of GetEmailCampaign' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetEmailCampaign)
    end
  end
