...
# Unit tests for SendinblueApiv3::CreateSmsCampaignRecipients
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSmsCampaignRecipients' do
  before do
    # run before each test
    @instance = SendinblueApiv3::CreateSmsCampaignRecipients.new
  end
  ...
  describe 'test an instance of CreateSmsCampaignRecipients' do
    it 'should create an instance of CreateSmsCampaignRecipients' do
      expect(@instance).to be_instance_of(SendinblueApiv3::CreateSmsCampaignRecipients)
    end
  end
