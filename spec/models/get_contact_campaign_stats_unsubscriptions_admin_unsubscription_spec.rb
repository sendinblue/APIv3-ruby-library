...
# Unit tests for SendinblueApiv3::GetContactCampaignStatsUnsubscriptionsAdminUnsubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactCampaignStatsUnsubscriptionsAdminUnsubscription' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetContactCampaignStatsUnsubscriptionsAdminUnsubscription.new
  end
  ...
  describe 'test an instance of GetContactCampaignStatsUnsubscriptionsAdminUnsubscription' do
    it 'should create an instance of GetContactCampaignStatsUnsubscriptionsAdminUnsubscription' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetContactCampaignStatsUnsubscriptionsAdminUnsubscription)
    end
  end
