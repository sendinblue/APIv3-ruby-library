...
# Unit tests for SendinblueApiv3::GetSmtpTemplates
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSmtpTemplates' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetSmtpTemplates.new
  end
  ...
  describe 'test an instance of GetSmtpTemplates' do
    it 'should create an instance of GetSmtpTemplates' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetSmtpTemplates)
    end
  end
