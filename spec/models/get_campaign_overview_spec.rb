...
# Unit tests for SendinblueApiv3::GetCampaignOverview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCampaignOverview' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetCampaignOverview.new
  end
  ...
  describe 'test an instance of GetCampaignOverview' do
    it 'should create an instance of GetCampaignOverview' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetCampaignOverview)
    end
  end
