...
# Unit tests for SendinblueApiv3::GetSmsEventReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSmsEventReport' do
  before do
    # run before each test
    @instance = SendinblueApiv3::GetSmsEventReport.new
  end
  ...
  describe 'test an instance of GetSmsEventReport' do
    it 'should create an instance of GetSmsEventReport' do
      expect(@instance).to be_instance_of(SendinblueApiv3::GetSmsEventReport)
    end
  end
