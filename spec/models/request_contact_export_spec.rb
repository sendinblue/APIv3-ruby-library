...
# Unit tests for SendinblueApiv3::RequestContactExport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestContactExport' do
  before do
    # run before each test
    @instance = SendinblueApiv3::RequestContactExport.new
  end
  ...
  describe 'test an instance of RequestContactExport' do
    it 'should create an instance of RequestContactExport' do
      expect(@instance).to be_instance_of(SendinblueApiv3::RequestContactExport)
    end
  end
